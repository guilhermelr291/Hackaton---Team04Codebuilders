...
class FieldsComparerStub implements FieldsComparer {
  compare(data: any): HttpError | void {}
}

describe('AuthController', () => {
  let sut: AuthController;
  let fieldsComparerStub = new FieldsComparerStub();
  ...
  beforeEach(() => {
    ...
    sut = new AuthController(mockAuthService, fieldsComparerStub);
  ...
  describe('signUp', () => {
    test('Should call FieldsComparer with correct data', async () => {
      const validateSpy = vi.spyOn(fieldsComparerStub, 'compare');
    ...
    test('Should call next when FieldsComparer throws', async () => {
      const error = new Error();

      vi.spyOn(fieldsComparerStub, 'compare').mockImplementationOnce(() => {
        throw error;
      });
